...
<div class="about">
   ...
   <div class="container">
    <div class="about-content">
        ...
        <div class="about-item mg ltr-effect padd">
        ...
        <a href="College of Arts and Sciences.php">
        <div class="about-item ltr-effect f padd">
        ...
        <a href="Faculty of Educational Sciences.php">
        <div class="about-item ltr-effect  padd R">
            <i class="fa fa-cogs">كلية العلوم التربوية</i>
            <h2 class="about-item-title"></h2>
