...
.majors-menu{
    ...
    padding: 4% 0;
    background-image: url(admin/images/AI-is-coming-—-and-HR-is-not-prepared.JPG);
...
<form action="" method="post">
    ...
    <div class="majors-menu-box">
    <div class="majors-menu-desc">
    <a href=""><h2><button name="ins"> Information systems and networks</button></h2></a>
    </div>
    </div>
    <div class="majors-menu-box">
    <div class="majors-menu-desc">
    <a href=""><h2><button name="ins"> Information Security and Confidentiality Department</button></h2></a>
    </div>
    </div>
    </div>
    </div>
