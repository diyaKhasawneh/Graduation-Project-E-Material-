...
<section>
  <div class="log_img">
   <br>
    <div class="box1">
        <h1 style="text-align: center; font-size: 35px;font-family: Sans-serif;">wise course e- material</h1>
        ...
        else
        {
          ...
          ?>
            ...
            alert ("Login as Admin");
              window.location="student/Admin/profile.php";
            </script>
          <?php
        } 
        }
